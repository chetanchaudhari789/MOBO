...
import { Button, Card, CardContent, RealtimeStatusBadge } from '../components/ui';
  ...
  if (user.isVerifiedByMediator === false) {
    return (
      <div className="min-h-screen w-full bg-slate-50 relative p-8 flex flex-col items-center justify-center text-center overflow-hidden">
        <div className="absolute top-[calc(1rem+env(safe-area-inset-top))] right-4 z-20 pointer-events-none">
