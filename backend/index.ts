...
async function main() {
  ...
  // No automatic seeding — all data comes from MongoDB migration.
  // Seed scripts (seedE2E, seedAdmin, seedDev) are available as standalone
  // CLI tools only if needed, never run on app startup.
